    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card auth-form mb-5">
                <div class="card-body">
                    <form method="POST" id="job_post" action="{{ route('job.update', $job->id) }}">
                        @csrf
                        @method('PATCH')
                    <div class="tab">
                        ...
                        <div class="form-group dis-cls">
                            ...
                            <div class="col-sm-8">
                                <select name="job_vacancies_type" id="job_vacancies_type" class="form-control{{ $errors->has('job_vacancies_type') ? ' is-invalid' : '' }}" required>
                                    ...
                                    <option value="Part-Time" {{$job->job_vacancies_type == 'Part-Time' ? 'selected' : ''}}>Part-Time</option>
                                    <option value="Contract" {{$job->job_vacancies_type == 'Contract' ? 'selected' : ''}}>Contract</option>
                                </select>
                        ...
                        <div class="form-group dis-cls">
                            ...
                            <div class="col-sm-3">
                                <input id="salary_offer" type="text" class="form-control{{ $errors->has('salary_offer') ? ' is-invalid' : '' }}" name="salary_offer" value="{{ $job->salary_offer }}" required>
                            </div>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group dis-cls">
                            ...
                            <div class="col-sm-2">
                                    <input id="postcode" type="text" class="form-control{{ $errors->has('postcode') ? ' is-invalid' : '' }}" name="postcode" value="{{ $job->postcode }}" placeholder="Postcode">
                            </div>
                            <div class="col-sm-2">
                                <input id="district" type="text" class="form-control{{ $errors->has('district') ? ' is-invalid' : '' }}" name="district" value="{{ $job->district }}" placeholder="District">
                            </div>
                            <div class="col-sm-2">
                                <input id="town" type="text" class="form-control{{ $errors->has('town') ? ' is-invalid' : '' }}" name="town" value="{{ $job->town }}" placeholder="Town">
                            </div>
                            <div class="col-sm-2">
                                <input id="state" type="text" class="form-control{{ $errors->has('state') ? ' is-invalid' : '' }}" name="state" value="{{ $job->state }}" placeholder="State">
                            </div>
                        </div>
                        <div class="form-group dis-cls">
                    ...
                    <div class="tab">
                        ...
                        <div class="form-group dis-cls">
                            ...
                            <div class="col-sm-8">
                                <select name="marital_status" id="marital_status" class="form-control{{ $errors->has('marital_status') ? ' is-invalid' : '' }}">
                                    ...
                                    <option value="Single" {{$job->marital_status == 'Single'  ? 'selected' : ''}}>Single</option>
                                    <option value="Married" {{$job->marital_status ==  'Married' ? 'selected' : ''}}>Married</option>
                                    <option value="Divorced" {{$job->marital_status ==  'Divorced' ? 'selected' : ''}}>Divorced</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group dis-cls">
                        ...
                        <div class="form-group dis-cls">
                            ...
                            <div class="col-sm-8">
                                <textarea name="other_requirements" id="other_requirements" class="form-control{{ $errors->has('other_requirements') ? ' is-invalid' : '' }}" cols="30" rows="6">{{ $job->other_requirements }}</textarea>
                        ...
                        <div class="form-group dis-cls">
                            ...
                            <div class="col-md-8 mt-2">
                                <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="custom-control custom-checkbox d-inline">
                                                <input type="checkbox" class="custom-control-input" id="{{$facility->name}}" name="facilities[]" value="{{$facility->name}}"
                                                    @if(strpos($job->facilities, $facility->name) !== FALSE)
                                                        {{'checked'}}
                                                    @endif
                                                >
                                    ...
                                    <div class="col-md-8">
                                        <div class="custom-control custom-checkbox d-inline">
                                            <input type="checkbox" class="custom-control-input" onclick="toogleOtherFacilities(this);" name="other_faliclities_checkbox" id="other" value="yes" {{$job->other_facilities ? 'checked' : ''}}>
                                            <label class="custom-control-label" for="other">Other</label>
                                            <input type="text" name="other_facilities" id="other_facilities" value="{{$job->other_facilities ?? ''}}" class="form-control {{$job->other_facilities ? '' : 'd-none'}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab">
                        ...
                        @foreach($job->languages as $jobLanguage)
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control{{ $errors->has('minimum_academic_qualification') ? ' is-invalid' : '' }}" name="minimum_academic_qualification" id="minimum_academic_qualification">
                                        @foreach ($academics as $academic)
                                            <option value="{{$academic->name}}" {{$academic->name == $job->minimum_academic_qualification ? 'selected' : ''}}>{{$academic->name}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control{{ $errors->has('academic_field') ? ' is-invalid' : '' }}" name="academic_field" id="academic_field">
                                        @foreach ($academic_fields as $academic_field)
                                            <option value="{{$academic_field->name}}" {{$academic_field->name == $job->academic_field ? 'selected' : ''}}>{{$academic_field->name}}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    <div class="form-group row dis-cls">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control{{ $errors->has('academic_qualification') ? ' is-invalid' : '' }}" name="academic_qualifications[]" id="academic_qualification">
                                                @foreach ($academics as $academic)
                                                    <option value="{{$academic->name}}" {{$academic->name == $jobAcademics->academic_qualification ? 'selected' : ''}}>{{$academic->name}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group row dis-cls">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control{{ $errors->has('academic_fields') ? ' is-invalid' : '' }}" name="academic_fields[]" id="academic_fields">
                                                @foreach ($academic_fields as $academic_field)
                                                    <option value="{{$academic_field->name}}" {{$academic_field->name == $jobAcademics->academic_field ? 'selected' : ''}}>{{$academic_field->name}}</option>
                                                @endforeach
                                            </select>
                        ...
                        <div class="form-group dis-cls">
                            ...
                            <div class="col-sm-8">
                                <input id="driving_license" type="text" class="form-control{{ $errors->has('driving_license') ? ' is-invalid' : '' }}" name="driving_license" value="{{ $job->driving_license }}">
                        ...
                        <div class="form-group dis-cls">
                            ...
                            <div class="col-sm-8">
                                <textarea name="other_skills" id="other_skills" class="form-control{{ $errors->has('other_skills') ? ' is-invalid' : '' }}" cols="30" rows="6">{{ $job->other_skills }}</textarea>
